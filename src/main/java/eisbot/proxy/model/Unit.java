...
public class Unit {
    ...
    public Order getOrder() {
        return Order.fromId(getOrderID());
    }
    ...
    /**
     * Don't use this, use getOrder().
     *
     * @return The BWAPI int id of this order, which is NOT the same as the
     *         ordinal in OrderTypeTypes.
     * @see #getOrder()
     */
    @Deprecated
    ...
    /**
     * Returns true when a unit has been issued an order to build a structure
     * and is moving to the build location. Also returns true for Terran SCVs
     * while they construct a building.
     * @return see above.
     */
